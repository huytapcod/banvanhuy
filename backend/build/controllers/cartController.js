    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return cartService.getCart(req.user.id);
        case 1:
          cart = _context.v;
          res.json(cart);
          _context.n = 3;
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        ...
        case 1:
          ...
          _context2.n = 2;
          return cartService.addToCart(userId, req.body);
        case 2:
          cart = _context2.v;
          res.json(cart);
          _context2.n = 4;
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          _context3.p = 0;
          _context3.n = 1;
          return cartService.updateCartItem(req.user.id, req.body);
        case 1:
          cart = _context3.v;
          res.json(cart);
          _context3.n = 3;
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.n) {
        case 0:
          _context4.p = 0;
          _context4.n = 1;
          return cartService.removeFromCart(req.user.id, req.body);
        case 1:
          cart = _context4.v;
          res.json(cart);
          _context4.n = 3;
        ...
        case 2:
          ...
          _t4 = _context4.v;
          res.status(500).json({
            message: "Lỗi xóa sản phẩm khỏi giỏ",
            error: _t4.message
          });
        case 3:
...
var clearCart = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.n) {
        case 0:
          _context5.p = 0;
          _context5.n = 1;
          return cartService.clearCart(req.user.id);
        case 1:
          result = _context5.v;
          res.json(result);
          _context5.n = 3;
  ...
  return function clearCart(_x9, _x0) {
...
var removeMultipleItemsFromCart = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.n) {
        case 0:
          _context6.p = 0;
          _context6.n = 1;
          return cartService.removeMultipleItemsFromCart(req.user.id, req.body.items);
        case 1:
          result = _context6.v;
          res.json(result);
          _context6.n = 3;
        ...
        case 2:
          _context6.p = 2;
          _t6 = _context6.v;
          console.error("Lỗi khi xóa nhiều sản phẩm khỏi giỏ hàng:", _t6);
          res.status(500).json({
  ...
  return function removeMultipleItemsFromCart(_x1, _x10) {
